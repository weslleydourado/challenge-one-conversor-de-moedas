package dev.wlly.challengecambio.model;
...
public class MenuDoUsuario {
    ...
    public MenuDoUsuario(ConversorDeMoedas conversor) {
    ...
    public void exibirMenu() {
        ...
        System.out.println("----------------------------------------------------------");
        System.out.println("- Escolha uma opção para converter ou '0' zero para SAIR -");
        System.out.println("----------------------------------------------------------");
    }
